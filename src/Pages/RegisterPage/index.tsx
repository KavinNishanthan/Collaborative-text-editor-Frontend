    ...
    <div className="min-h-screen bg-linear-to-br from-[#F8FAFC] via-[#EEF2FF] to-[#F0F9FF] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md animate-slide-up">
        ...
        <div className="bg-white border border-black/6 rounded-2xl p-8 shadow-[0_8px_48px_rgba(0,0,0,0.06)]">
          {/* Step indicator */}
          <div className="flex items-center mb-7 text-5xl">
            Colab<span className="text-blue-600">Edit</span>
          </div>

          {step === 'register' ? (
            <>
              <div className="mb-6">
                <h1 className="text-2xl font-bold mb-1.5 text-[#0F172A]">Create your account</h1>
                <p className="text-sm text-[#64748B]">Join thousands of teams writing better</p>
              </div>
              <form onSubmit={handleRegister} className="flex flex-col gap-4">
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input type="text" className={inputCls} placeholder="Kavin Nishanthan" value={form.name}
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input type={showPass ? 'text' : 'password'} className={`${inputCls} pr-10`} placeholder="Min. 8 characters" value={form.password}
            ...
            <>
              <div className="mb-6">
                <h1 className="text-2xl font-bold mb-1.5 text-[#0F172A]">Verify your email</h1>
                <p className="text-sm text-[#64748B]">
                  We sent a 6-digit OTP to <span className="text-[#0F172A] font-medium">{form.email}</span>
                </p>
              </div>
              <form onSubmit={handleVerify} className="flex flex-col gap-4">
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-medium text-[#64748B]">OTP Code</label>
                  <input
                    type="text"
                    maxLength={6}
          ...
          <p className="mt-6 text-center text-sm text-[#64748B]">
            ...
            <Link to="/login" className="text-[#4F46E5] hover:text-[#4338CA] font-medium transition-colors">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
